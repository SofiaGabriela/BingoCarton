...
class BingoCarton extends StatefulWidget {
  ...
  ///pudiendo modificarse esta cantidad si es necesario.
  ///
  ///En el caso de modificar la cantidad, tener en cuenta que el numero de cartones en total tiene que superar
  ///al numero de la cantidad.
  ///
  ///Tambien se puede customizar el color principal que modificara los colores de los
  /// cartones, el selector y el boton para realizar el pago.
...
class _BingoCartonState extends State<BingoCarton> {
  ...
  void addBingo(BingoModel bingo) {
    setState(() {
      ...
      } else if (selectedBingos.length < widget.maxAmount) {
          ...
          child: Row(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  '${selectedBingos.length.toString()} / ${widget.maxAmount}',
                  style: TextStyle(
                      color: widget.color,
                      fontSize: 14,
                      fontWeight: FontWeight.bold),
